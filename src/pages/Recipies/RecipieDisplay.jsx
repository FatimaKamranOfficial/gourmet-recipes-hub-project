...
const RecipieDisplay = () => {
  ...
  React.useEffect(() => {
    fetch(`https://api.spoonacular.com/recipes/complexSearch?query=${params.id}&apiKey=${process.env.REACT_APP_KEY}&addRecipeInformation=${true}&number=1`)
      .then(res => res.json())
        ...
        <div className="right">
          ...
          <div className="display">
            ...
            <div className={toggle === 3 ? "active" : "content"}>
              <p>Cooking Time: {item.readyInMinutes}</p>
            </div>
